...
import com.pity.baradopta.data.modelos.Solicitud;
import com.pity.baradopta.data.modelos.SolicitudReference;
import com.pity.baradopta.data.modelos.SolicitudesCache;
    ...
    public void initView() {
        new AsyncTask<Void, Void, Usuario>(){
            ...
            protected Usuario doInBackground(Void... voids) {
                ...
                UserRepository.getInstance().getCurrentUser(new IUserRepository.CallbackQueryUser() {
                    @Override
                    public void onSuccessUserQueryById(Usuario user) {
                        UserRepository.getInstance().attachUser(user);
                        logedUser[0] = user;
            ...
            protected void onPostExecute(Usuario logedUser) {
                ...
                view.populateView(logedUser.getDisplayName(), cantAdoptados, cantPublicados, cantEncontrados, logedUser.getUrlFotoPerfil());
